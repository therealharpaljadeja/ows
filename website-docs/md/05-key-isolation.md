...
This document complements the normative security requirements in `08-conformance-and-security.md`. It describes recommended implementation strategies and deployment profiles rather than a single mandatory architecture.
